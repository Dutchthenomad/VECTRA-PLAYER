...
print("Output: /home/devops/rugs_data/analysis/")
print("\n" + "=" * 80)
...
try:
    ...
    print(
        f"   - Mean return: {comparison_df[comparison_df['Strategy'] == 'Quarter Kelly']['Total Return (%)'].values[0]:.1f}%"
    )
    print(
        f"   - Max drawdown: {comparison_df[comparison_df['Strategy'] == 'Quarter Kelly']['Max Drawdown (%)'].values[0]:.1f}%"
    )
    print(
        f"   - Sharpe ratio: {comparison_df[comparison_df['Strategy'] == 'Quarter Kelly']['Sharpe Ratio'].values[0]:.2f}"
    )
