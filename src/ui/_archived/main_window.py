...
class MainWindow(
    ...
    def _setup_event_handlers(self):
        """Set up event bus handlers for UI updates."""
        # Event handlers are set up in individual controllers
        # This method exists for future centralized event handling
        pass

    def _setup_toast_handlers(self):
        """Set up toast notification handlers for events."""
        # Toast notifications are handled inline in controllers
        # This method exists for future centralized toast handling
        pass

    def _setup_keyboard_shortcuts(self):
        """Set up keyboard shortcuts for the application."""
        # Keyboard shortcuts bound in _create_ui
        # This method exists for future centralized shortcut handling
        pass
    ...
    def _initialize_controllers(self):
        ...
        self.trading_controller = TradingController(
            ...
            toast=self.toast,
            log_callback=self.log,
            event_bus=self.event_bus,  # Phase B: ButtonEvent emission
            live_state_provider=self.live_state_provider,  # Phase B: live game context
        )
