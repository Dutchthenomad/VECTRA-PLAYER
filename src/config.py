...
class Config:
    ...
    def get_data_config(cls) -> dict:
        ...
        return {
            ...
            "legacy_recorders_enabled": os.getenv("RUGS_LEGACY_RECORDERS", "false").lower()
            == "true",
    ...
    def get_files_config(cls) -> dict:
        ...
        return {
            "recordings_dir": Path(
                os.getenv("RUGS_RECORDINGS_DIR", str(base_dir / "rugs_recordings"))
            ),
            "config_dir": Path(os.getenv("RUGS_CONFIG_DIR", str(Path.home() / ".rugs_viewer"))),
            "log_dir": Path(os.getenv("RUGS_LOG_DIR", str(Path.home() / ".rugs_viewer" / "logs"))),
    ...
    def __init__(
        ...
        self._files_config: dict | None = None
    ...
    def validate(self):
        ...
        try:
            ...
            if (
                self.BOT.get("default_strategy")
                and self.BOT["default_strategy"] not in valid_strategies
            ):
